...
class DensityOfStates:
    ...
    def __init__(self, vasprun_xml_file: Path | str):
        ...
        try:
            ...
            self.dos_element = self.vasprun_root.find(
                'calculation').find('dos')
...
class BandStructure:
    ...
    def __init__(self, structure: Structure, ):
        ...
        self.kpoint_elements = structure.root.xpath(
    ...
    def plot_3d(self, bands: list[int], title: str = None):
        ...
        if title == None:
            title = f'3D Band Structure of {self.structure.formula} (bands {", ".join(str(band) for band in band_indices)})'

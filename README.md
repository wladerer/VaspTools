...
| --- | --- | --- | --- |
| `write_kpoints()` | self, save path | KPOINTS file | Writes an explicit kpoint mesh generated by vasp |
| `write_incar()` | self, save path | INCAR fle | Writes an INCAR of the user specified tags |
